    ...
    >
      ...
      >
        <Image
          ...
          h="30px"
          mr={3}
          fallbackSrc="https://via.placeholder.com/30/ffffff?text=G"
        />
      ...
      >
        {navLinks.map((link) => (
          <ChakraLink
            key={link.id}
            href={`#${link.id}`}
            color={activeSection === link.id ? "blue.300" : "white"}
      ...
      >
        <Box as={motion.div} {...slideLeft} flex={1} pr={{ md: 10 }}>
          ...
          <Text
            ...
            transition={smoothTransition}
          >
            Access verified scholarship programs, submit your application
            online, and track your progress in real time — all in one secure
            platform.
          </Text>
        ...
        <Box as={motion.div} {...slideRight} flex={1} mb={{ base: 10, md: 0 }}>
          <Image
            ...
            fallbackSrc="https://via.placeholder.com/600x400?text=Illustration+of+Students+and+Books"
            w="full"
...
const Discover = () => {
  ...
  const cardBg = useColorModeValue("brand.mediumBlue", "#1a4e6e");
  const cardBorder = useColorModeValue("transparent", "#2c7aab");
  const cardShadow = useColorModeValue("lg", "dark-lg");

  const btnBg = useColorModeValue("white", "blue.300");
  const btnColor = useColorModeValue("brand.mediumBlue", "#1a4e6e");
  const btnHoverBg = useColorModeValue("gray.100", "blue.200");

  // --- NEW: State to hold database data ---
  const [scholarships, setScholarships] = useState([]);
  const [isLoading, setIsLoading] = useState(true);

  // --- NEW: Fetch data on page load ---
  useEffect(() => {
  ...
  return (
    ...
    >
      <Container maxW="7xl">
        ...
        {/* Loading State Check */}
        {isLoading ? (
          <Text textAlign="center" color={headingColor}>
          ...
          <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={8}>
            {scholarships.map((scholarship, index) => (
              <Box
                as={motion.div}
                key={scholarship._id} // Changed from .id to ._id for MongoDB!
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: "-50px" }}
                transition={{
  ...
  return (
    ...
    >
      <Box
        ...
        position="relative"
        zIndex={2}
        borderBottomRadius={{ base: "50% 40px", md: "50% 120px" }}
        transition={smoothTransition}
      >
        <Container maxW="4xl">
          <Heading
          ...
          <Text
            ...
            transition={smoothTransition}
          >
            Helps students easily discover scholarships, apply online, and track
            their application status, while providing administrators a simple
            way to manage and organize programs efficiently.
          </Text>
        </Container>
      </Box>
        ...
        <Container maxW="6xl">
          ...
          >
            <Feature
              ...
              text="Minimizes manual forms by moving the process online."
            />
            <Feature
              delay={0.15}
              title="Faster Application Processing"
              text="Speeds up submission and review to reduce waiting time."
            />
            <Feature
              delay={0.3}
              title="Real-Time Status Tracking"
              text="Lets users monitor application progress instantly."
            />
          </SimpleGrid>
          <Flex
            justify="center"
          ...
          >
            <Box maxW={{ base: "100%", md: "280px" }}>
              <Feature
                ...
                text="Provides clear visibility of application updates and decisions."
              />
            </Box>
            <Box maxW={{ base: "100%", md: "280px" }}>
              <Feature
                ...
                text="Keeps records structured and easy to manage."
              />
            </Box>
          </Flex>
        </Container>
...
const MissionVision = () => {
  ...
  return (
    <Box
      ...
      borderTopRadius={{ base: "50% 40px", md: "50% 150px" }}
      position="relative"
      zIndex={2}
      overflow="hidden"
      transition={smoothTransition}
          ...
          >
            ...
            >
              ...
              <Text fontSize={{ base: "sm", md: "lg" }} lineHeight="1.8">
                To provide a seamless, efficient, and transparent platform that
                empowers students to access scholarship opportunities while
                enabling administrators to manage programs effectively.
              </Text>
            </Box>
            <Box
              as={motion.div}
            ...
            >
              <Image
                ...
                fallbackSrc="https://via.placeholder.com/600x400?text=Mission+Illustration"
                w="full"
                dropShadow="2xl"
              />
            </Box>
          ...
          >
            ...
            >
              <Image
                ...
                fallbackSrc="https://via.placeholder.com/600x400?text=Vision+Illustration"
                w="full"
                dropShadow="2xl"
              />
            </Box>
            ...
            >
              ...
              <Text fontSize={{ base: "sm", md: "lg" }} lineHeight="1.8">
                To become the leading digital solution for scholarship
                management, ensuring that every deserving student has equal
          ...
          <VStack align={{ base: "center", md: "start" }} spacing={4}>
            <Flex align="center">
              <Image
                ...
                h="24px"
                mr={3}
                fallbackSrc="https://via.placeholder.com/24/ffffff?text=G"
              />
            ...
            <Text fontSize="sm">
              Streamlining scholarships to save time, reduce paperwork, and
              support student success. Empowering students and institutions with
              a faster, smarter, and more transparent application experience.
            </Text>
            <HStack spacing={4}>
              <Icon
                as={FaFacebook}
