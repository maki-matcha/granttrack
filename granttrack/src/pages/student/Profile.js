...
export default function StudentProfile() {
  ...
  const [avatarUrl, setAvatarUrl] = useState(
    () => localStorage.getItem("granttrack_student_avatar") || "",
  );

  useEffect(() => {
    const handleStorageChange = () =>
      setAvatarUrl(localStorage.getItem("granttrack_student_avatar") || "");
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      // Retrieve the logged-in user from localStorage (set this during login)
    ...
    reader.onloadend = () => {
      try {
        ...
        toast({
          title: "Storage Error",
          description:
            "Image resolution is too high for local browser storage.",
          status: "warning",
          duration: 4000,
          position: "top-right",
        });
  ...
  const handleRequestNameChange = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description:
          "Your request to update your registered name has been forwarded to the Administrator.",
        status: "info",
        duration: 5000,
        position: "top-right",
      });
  ...
  return (
    <DashboardLayout
      ...
      userDetail={profileData.studentId}
    >
      <input
        type="file"
        accept="image/*"
          ...
          >
            ...
            <VStack align="start" spacing={3} w="full">
              ...
              >
                ...
                <Text>{profileData.studentId}</Text>
              </HStack>
              <HStack
                color={subtitleColor}
                fontSize="sm"
              ...
              >
                ...
                <Text isTruncated>{profileData.email}</Text>
              </HStack>
            </VStack>
          </Box>
        </VStack>
